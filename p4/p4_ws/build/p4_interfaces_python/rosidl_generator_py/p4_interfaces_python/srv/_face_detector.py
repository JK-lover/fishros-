...
class Metaclass_FaceDetector_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('p4_interfaces_python')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_FaceDetector(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'p4_interfaces_python.srv.FaceDetector')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from p4_interfaces_python.srv import _face_detector
...
class FaceDetector(metaclass=Metaclass_FaceDetector):
    from p4_interfaces_python.srv._face_detector import FaceDetector_Request as Request
    from p4_interfaces_python.srv._face_detector import FaceDetector_Response as Response
